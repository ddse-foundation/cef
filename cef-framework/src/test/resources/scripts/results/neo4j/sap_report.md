...
**Backend:** neo4j
**Generated:** 2025-12-07T15:23:08.132142619Z
...
| Latency (p50) | 15 ms | 34 ms | +19 ms |
| Latency (p95) | 17 ms | 46 ms | +29 ms |
...
| Latency (p50) | 16 ms | 36 ms | +20 ms |
| Latency (p95) | 18 ms | 40 ms | +22 ms |
...
| Latency (p50) | 17 ms | 42 ms | +25 ms |
| Latency (p95) | 19 ms | 44 ms | +25 ms |
...
| Metric | Vector-Only | Knowledge Model | Improvement |
|--------|-------------|-----------------|-------------|
| Chunks Retrieved | 5 | 6 | +1 (20%) |
| Latency (p50) | 15 ms | 34 ms | +19 ms |
| Latency (p95) | 18 ms | 36 ms | +18 ms |
...
| Latency (p50) | 18 ms | 32 ms | +14 ms |
| Latency (p95) | 20 ms | 39 ms | +19 ms |
...
| Metric | Value |
|--------|-------|
| Avg Chunk Improvement | 32.0% |
| Avg Latency Overhead | 120.6% |
| Total Benchmark Time | 1,820 ms |
