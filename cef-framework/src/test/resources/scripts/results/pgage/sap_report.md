...
**Backend:** pgage
**Generated:** 2025-12-07T16:00:52.063031234Z
...
| Latency (p50) | 17 ms | 353 ms | +336 ms |
| Latency (p95) | 22 ms | 382 ms | +360 ms |
...
| Metric | Vector-Only | Knowledge Model | Improvement |
|--------|-------------|-----------------|-------------|
| Chunks Retrieved | 0 | 0 | +0 (0%) |
| Latency (p50) | 14 ms | 27 ms | +13 ms |
| Latency (p95) | 18 ms | 29 ms | +11 ms |
...
|--------|-------------|-----------------|-------------|
| Chunks Retrieved | 0 | 0 | +0 (0%) |
| Latency (p50) | 13 ms | 27 ms | +14 ms |
| Latency (p95) | 14 ms | 30 ms | +16 ms |
...
|--------|-------------|-----------------|-------------|
| Chunks Retrieved | 0 | 0 | +0 (0%) |
| Latency (p50) | 15 ms | 30 ms | +15 ms |
| Latency (p95) | 22 ms | 39 ms | +17 ms |
...
| Metric | Value |
|--------|-------|
| Avg Chunk Improvement | -16.0% |
| Avg Latency Overhead | 476.8% |
| Total Benchmark Time | 6,756 ms |
