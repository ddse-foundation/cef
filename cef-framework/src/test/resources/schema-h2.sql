-- H2 Schema for Nodes and Edges (Graph)
...
-- Create chunks table for vector storage (matching ChunkRepository interface)
CREATE TABLE IF NOT EXISTS chunks (
    ...
    metadata VARCHAR,
    created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (linked_node_id) REFERENCES nodes(id) ON DELETE CASCADE
);
